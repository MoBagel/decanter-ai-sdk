...
class Experiment(BaseModel):
    ...
    def get_best_model_by_metric(self, metric: Union[ClassificationMetric, RegressionMetric]) -> Model:
        ...
        Args:
            metric (:class: `~decanter_ai_sdk.enums.evaluators.ClassificationMetric` or `decanter_ai_sdk.enums.evaluators.RegressionMetric`): Standard metric.
        
        Returns:
            (:class: `~decanter_ai_sdk.web_api.model.Model`): Best model selected by input metric.
        """
        if (
