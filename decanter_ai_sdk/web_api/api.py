...
class Api:
    ...
    def get_pred_data(self, pred_id):
        ...
        status_code = None
        print(self.url + "prediction/" + pred_id + "/download")
        # while(status_code != 200):
        #     prediction_get_response = requests.get(
        #         f'{self.url}/prediction/{pred_id}/download', headers=self.headers, data=data, verify=False)
